...
- Status: `PASS`
- Generated At: `2026-07-13T01:42:47+08:00`
...
- empty_count: `2`
- blocked_count: `1`
- priority_ready_count: `4`
- historical_scan_target: `daily_core`
- historical_scan_pass_count: `3`

## Endpoints

| Module | Endpoint | Status | Rows | Notes |
| --- | --- | --- | ---: | --- |
| 主力资金流向 | `moneyflow` | `PASS` | 5085 | historical_match=20240703; ts_code, trade_date, buy_sm_vol, buy_sm_amount, sell_sm_vol, sell_sm_amount |
| 龙虎榜 / 游资席位 | `top_list` | `EMPTY` | 0 | trade_date, ts_code, name, close, pct_change, turnover_rate |
| 龙虎榜 / 游资席位 | `top_inst` | `EMPTY` | 0 | trade_date, ts_code, exalter, buy, buy_rate, sell |
...
| A 股因子与日线基础池 | `stk_factor` | `PASS` | 5583 | historical_match=20240703; ts_code, trade_date, close, open, high, low |
| A 股因子与日线基础池 | `daily_basic` | `PASS` | 5335 | historical_match=20240703; ts_code, trade_date, close, turnover_rate, turnover_rate_f, volume_ratio |
