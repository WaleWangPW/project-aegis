...
- Status: `PASS`
- Generated At: `2026-07-13T00:17:48+08:00`
...
- empty_count: `5`
- blocked_count: `1`
- priority_ready_count: `3`

## Endpoints

| Module | Endpoint | Status | Rows | Notes |
| --- | --- | --- | ---: | --- |
| 主力资金流向 | `moneyflow` | `EMPTY` | 0 | ts_code, trade_date, buy_sm_vol, buy_sm_amount, sell_sm_vol, sell_sm_amount |
...
| A 股因子与日线基础池 | `stk_factor` | `EMPTY` | 0 | ts_code, trade_date, close, open, high, low |
| A 股因子与日线基础池 | `daily_basic` | `EMPTY` | 0 | ts_code, trade_date, close, turnover_rate, turnover_rate_f, volume_ratio |
