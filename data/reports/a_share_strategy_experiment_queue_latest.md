...
- Status: `PASS`
- Generated At: `2026-07-13T11:25:54+08:00`
- Experiments: `6`
- Ready: `6`
- Blocked: `0`
...
| 5 | `exp_a_signal_tuning_result_review` | `READY_TUNING_REWORK` | 复核主力资金、筹码集中、机构持仓、治理 veto-only 等调优实验是否改善；即便通过也不能直接进推荐。 | 至少 1 个 tuned experiment 指标改善且后续通过 Codex-reviewed refined/ranking gate；在此之前 ranking_impact_allowed=false。 |
