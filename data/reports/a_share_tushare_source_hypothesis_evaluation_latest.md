...
| --- | --- | --- | ---: | ---: | --- |
| `hyp_a_tushare_capital_flow_accumulation` | `proxy_fail` | `PROXY` | 62 | -0.0943 | proxy_win_rate_below_threshold, proxy_average_return_below_threshold, proxy_average_drawdown_too_deep |
| `hyp_a_tushare_dragon_tiger_seat_confirmation` | `proxy_fail` | `PROXY` | 62 | -0.0943 | proxy_win_rate_below_threshold, proxy_average_return_below_threshold, proxy_average_drawdown_too_deep |
...
| `hyp_a_tushare_holder_concentration_improvement` | `proxy_fail` | `PROXY` | 62 | -0.0943 | proxy_win_rate_below_threshold, proxy_average_return_below_threshold, proxy_average_drawdown_too_deep |
| `hyp_a_tushare_factor_liquidity_quality_overlay` | `proxy_fail` | `PROXY` | 62 | -0.0943 | proxy_win_rate_below_threshold, proxy_average_return_below_threshold, proxy_average_drawdown_too_deep |
