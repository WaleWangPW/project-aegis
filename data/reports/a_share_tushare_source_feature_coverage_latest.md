...
- Status: `PASS`
- Generated At: `2026-07-13T02:00:24+08:00`
...
| --- | --- | ---: | ---: | --- |
| `hyp_a_tushare_capital_flow_accumulation` | `READY_FOR_DEEP_SANDBOX` | 76 | 1.00 | moneyflow |
| `hyp_a_tushare_institutional_ownership_stability` | `READY_FOR_DEEP_SANDBOX` | 40 | 1.00 | top10_holders, top10_floatholders |
| `hyp_a_tushare_holder_concentration_improvement` | `READY_FOR_DEEP_SANDBOX` | 76 | 0.95 | stk_holdernumber |
| `hyp_a_tushare_factor_liquidity_quality_overlay` | `READY_FOR_DEEP_SANDBOX` | 76 | 1.00 | stk_factor, daily_basic |
