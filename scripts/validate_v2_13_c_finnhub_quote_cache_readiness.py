#!/usr/bin/env python3
"""Validate V2.13-C Finnhub quote cache readiness dry run."""
...
from aegis.external_sources.finnhub_quote_cache_readiness import (  # noqa: E402
    build_finnhub_quote_cache_readiness_report,
    render_finnhub_quote_cache_readiness_markdown,
)

REPORTS_DIR = ROOT / "data" / "reports"
OUTPUT_ROOT = ROOT / "data" / "processed" / "v2_13_c_acceptance"
SOURCE_METADATA_REPORT_JSON = ROOT / "data" / "reports" / "v2_13_b_finnhub_metadata_activation_latest.json"

PASS_MARKER = "V2_13_C_FINNHUB_QUOTE_CACHE_READINESS_PASS.marker"
FAIL_MARKER = "V2_13_C_FINNHUB_QUOTE_CACHE_READINESS_FAIL.marker"
REPORT_JSON = "v2_13_c_finnhub_quote_cache_readiness_latest.json"
REPORT_MD = "v2_13_c_finnhub_quote_cache_readiness_latest.md"
...
def run_acceptance(
    *,
    ...
    run_id: str = "v2_13_c_20260712_acceptance",
    ...
    cache_dir = run_dir / "normalized_quote_cache"
    ...
    readiness_report_json = run_dir / "finnhub_quote_cache_readiness_report.json"
    readiness_report_md = run_dir / "finnhub_quote_cache_readiness_report.md"
    _write_json(readiness_report_json, report)
    readiness_report_md.write_text(render_finnhub_quote_cache_readiness_markdown(report), encoding="utf-8")

    checks = {
        **report["checks"],
        "acceptance_target_correct": report["acceptance_target"] == "V2.13-C Finnhub Quote Cache Readiness Dry Run",
        ...
        "normalized_quote_cache_dir_exists": cache_dir.exists(),
    ...
    report_md.write_text(render_finnhub_quote_cache_readiness_markdown(report), encoding="utf-8")
    ...
    (reports_dir / marker_name).write_text(
        "\n".join(
            [
                ...
                "target=V2.13-C Finnhub Quote Cache Readiness Dry Run",
                ...
                f"normalized_quote_cache_root={cache_dir}",
                ...
                f"quote_cache_ready={str(report['summary']['quote_cache_ready']).lower()}",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-id", default="v2_13_c_20260712_acceptance")
    ...
    print(
        ...
        f"quote_cache_ready={report['summary']['quote_cache_ready']}",
