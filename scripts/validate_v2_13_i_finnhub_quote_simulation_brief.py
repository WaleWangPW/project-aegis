#!/usr/bin/env python3
"""Validate V2.13-I Finnhub quote current simulation brief."""
...
from aegis.external_sources.finnhub_quote_simulation_brief import (  # noqa: E402
    ACCEPTANCE_TARGET,
...
OUTPUT_ROOT = ROOT / "data" / "processed" / "v2_13_i_acceptance"
SOURCE_V2_13_H_REPORT_JSON = REPORTS_DIR / "v2_13_h_finnhub_quote_suggestion_gate_latest.json"
SOURCE_V2_13_H_PASS_MARKER = REPORTS_DIR / "V2_13_H_FINNHUB_QUOTE_SUGGESTION_GATE_PASS.marker"
...
PASS_MARKER = "V2_13_I_FINNHUB_QUOTE_SIMULATION_BRIEF_PASS.marker"
FAIL_MARKER = "V2_13_I_FINNHUB_QUOTE_SIMULATION_BRIEF_FAIL.marker"
REPORT_JSON = "v2_13_i_finnhub_quote_simulation_brief_latest.json"
REPORT_MD = "v2_13_i_finnhub_quote_simulation_brief_latest.md"
...
def run_acceptance(
    *,
    ...
    run_id: str = "v2_13_i_20260712_acceptance",
    command: str | None = None,
    source_v2_13_h_report_json: Path = SOURCE_V2_13_H_REPORT_JSON,
    source_v2_13_h_pass_marker: Path = SOURCE_V2_13_H_PASS_MARKER,
    ...
    gate_report = _load_json(source_v2_13_h_report_json)
    ...
    brief_json = run_dir / "finnhub_quote_current_simulation_brief.json"
    brief_md = run_dir / "finnhub_quote_current_simulation_brief.md"
    _write_json(brief_json, brief)
    brief_md.write_text(render_finnhub_quote_current_simulation_brief_markdown(brief), encoding="utf-8")
    ...
    checks = {
        **brief["checks"],
        ...
        "source_marker_exists": source_v2_13_h_pass_marker.exists(),
    ...
    brief["source_v2_13_h_report_json"] = str(source_v2_13_h_report_json)
    brief["source_v2_13_h_pass_marker"] = str(source_v2_13_h_pass_marker)
    brief["production_record_files_before"] = before
    brief["production_record_files_after"] = after
    brief["hashes"] = {
        "source_v2_13_h_report_json": _sha256(source_v2_13_h_report_json),
        "source_v2_13_h_pass_marker": _sha256(source_v2_13_h_pass_marker),
    ...
    report_md.write_text(render_finnhub_quote_current_simulation_brief_markdown(brief), encoding="utf-8")
    ...
    (reports_dir / marker_name).write_text(
        "\n".join(
            [
                ...
                f"source_v2_13_h_report_json={source_v2_13_h_report_json}",
                f"source_v2_13_h_report_json_sha256={_sha256(source_v2_13_h_report_json)}",
                f"source_v2_13_h_pass_marker={source_v2_13_h_pass_marker}",
                f"source_v2_13_h_pass_marker_sha256={_sha256(source_v2_13_h_pass_marker)}",
                ...
                f"social_sentiment_status={brief['summary']['social_sentiment_status']}",
                "network_used=false",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-id", default="v2_13_i_20260712_acceptance")
    parser.add_argument("--source-v2-13-h-report-json", type=Path, default=SOURCE_V2_13_H_REPORT_JSON)
    parser.add_argument("--source-v2-13-h-pass-marker", type=Path, default=SOURCE_V2_13_H_PASS_MARKER)
    ...
    report = run_acceptance(
        ...
        run_id=args.run_id,
        command=command,
        source_v2_13_h_report_json=args.source_v2_13_h_report_json,
        source_v2_13_h_pass_marker=args.source_v2_13_h_pass_marker,
    )
    print(
        ACCEPTANCE_TARGET,
