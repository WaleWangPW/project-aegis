#!/usr/bin/env python3
"""Validate V2.12-H H/US feedback to paper simulation review queue."""
...
from aegis.paper.h_us_feedback_review_queue import (  # noqa: E402
    build_h_us_feedback_review_queue_report,
)

REPORTS_DIR = ROOT / "data" / "reports"
OUTPUT_ROOT = ROOT / "data" / "processed" / "v2_12_h_acceptance"
SOURCE_V2_12_G_REPORT_JSON = REPORTS_DIR / "v2_12_g_h_us_feedback_intake_latest.json"
SOURCE_V2_12_G_PASS_MARKER = REPORTS_DIR / "V2_12_G_H_US_FEEDBACK_INTAKE_PASS.marker"
...
PASS_MARKER = "V2_12_H_H_US_FEEDBACK_REVIEW_QUEUE_PASS.marker"
FAIL_MARKER = "V2_12_H_H_US_FEEDBACK_REVIEW_QUEUE_FAIL.marker"
REPORT_JSON = "v2_12_h_h_us_feedback_review_queue_latest.json"
REPORT_MD = "v2_12_h_h_us_feedback_review_queue_latest.md"
...
def run_acceptance(
    *,
    ...
    run_id: str = "v2_12_h_20260712_acceptance",
    command: str | None = None,
    source_v2_12_g_report_json: Path = SOURCE_V2_12_G_REPORT_JSON,
    source_v2_12_g_pass_marker: Path = SOURCE_V2_12_G_PASS_MARKER,
    ...
    source_report = _load_json(source_v2_12_g_report_json)
    report = build_h_us_feedback_review_queue_report(
        source_report,
        run_id=run_id,
        evidence_ref=str(source_v2_12_g_report_json),
        command=command,
    )
    review_queue_json = run_dir / "h_us_feedback_review_queue.json"
    ...
    checks = {
        **report["checks"],
        ...
        "source_marker_exists": source_v2_12_g_pass_marker.exists(),
    ...
    report["source_v2_12_g_report_json"] = str(source_v2_12_g_report_json)
    report["source_v2_12_g_pass_marker"] = str(source_v2_12_g_pass_marker)
    ...
    report["hashes"] = {
        "source_v2_12_g_report_json": _sha256(source_v2_12_g_report_json),
        "source_v2_12_g_pass_marker": _sha256(source_v2_12_g_pass_marker),
    ...
    (reports_dir / marker_name).write_text(
        "\n".join(
            [
                ...
                "target=V2.12-H H-US Feedback To Paper Simulation Review Queue",
                ...
                f"source_v2_12_g_report_json={source_v2_12_g_report_json}",
                f"source_v2_12_g_report_json_sha256={_sha256(source_v2_12_g_report_json)}",
                f"review_queue_count={report['summary']['review_queue_count']}",
                f"pending_user_price_date_evidence_count={report['summary']['pending_user_price_date_evidence_count']}",
                "network_used=false",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-id", default="v2_12_h_20260712_acceptance")
    parser.add_argument("--source-v2-12-g-report-json", type=Path, default=SOURCE_V2_12_G_REPORT_JSON)
    parser.add_argument("--source-v2-12-g-pass-marker", type=Path, default=SOURCE_V2_12_G_PASS_MARKER)
    ...
    report = run_acceptance(
        ...
        run_id=args.run_id,
        command=command,
        source_v2_12_g_report_json=args.source_v2_12_g_report_json,
        source_v2_12_g_pass_marker=args.source_v2_12_g_pass_marker,
    )
    print(
        "V2.12-H H-US Feedback To Paper Simulation Review Queue",
