#!/usr/bin/env python3
"""Validate V2.13-M Finnhub quote virtual PaperTrade creation from validated evidence."""
...
from aegis.paper.finnhub_quote_virtual_trade_creation import (  # noqa: E402
    build_finnhub_quote_virtual_trade_creation_report,
)

REPORTS_DIR = ROOT / "data" / "reports"
OUTPUT_ROOT = ROOT / "data" / "processed" / "v2_13_m_acceptance"
SOURCE_V2_13_L_REPORT_JSON = REPORTS_DIR / "v2_13_l_finnhub_quote_user_supplied_paper_evidence_latest.json"
SOURCE_V2_13_L_PASS_MARKER = REPORTS_DIR / "V2_13_L_FINNHUB_QUOTE_USER_SUPPLIED_PAPER_EVIDENCE_PASS.marker"
...
PASS_MARKER = "V2_13_M_FINNHUB_QUOTE_VIRTUAL_PAPER_TRADE_CREATION_PASS.marker"
FAIL_MARKER = "V2_13_M_FINNHUB_QUOTE_VIRTUAL_PAPER_TRADE_CREATION_FAIL.marker"
REPORT_JSON = "v2_13_m_finnhub_quote_virtual_paper_trade_creation_latest.json"
REPORT_MD = "v2_13_m_finnhub_quote_virtual_paper_trade_creation_latest.md"
...
def run_acceptance(
    *,
    ...
    run_id: str = "v2_13_m_20260712_acceptance",
    command: str | None = None,
    source_v2_13_l_report_json: Path = SOURCE_V2_13_L_REPORT_JSON,
    source_v2_13_l_pass_marker: Path = SOURCE_V2_13_L_PASS_MARKER,
    ...
    source_report = _load_json(source_v2_13_l_report_json)
    report = build_finnhub_quote_virtual_trade_creation_report(
        source_report,
        run_id=run_id,
        command=command,
    )
    ledger_json = run_dir / "finnhub_quote_virtual_paper_trades.json"
    ledger_jsonl = run_dir / "finnhub_quote_virtual_paper_trades.jsonl"
    ...
    checks = {
        **report["checks"],
        ...
        "source_marker_exists": source_v2_13_l_pass_marker.exists(),
    ...
    report["source_v2_13_l_report_json"] = str(source_v2_13_l_report_json)
    report["source_v2_13_l_pass_marker"] = str(source_v2_13_l_pass_marker)
    ...
    report["hashes"] = {
        "source_v2_13_l_report_json": _sha256(source_v2_13_l_report_json),
        "source_v2_13_l_pass_marker": _sha256(source_v2_13_l_pass_marker),
    ...
    (reports_dir / marker_name).write_text(
        "\n".join(
            [
                ...
                "target=V2.13-M Finnhub Quote Virtual PaperTrade Creation From Validated Evidence",
                ...
                f"source_v2_13_l_report_json={source_v2_13_l_report_json}",
                f"source_v2_13_l_report_json_sha256={_sha256(source_v2_13_l_report_json)}",
                f"virtual_paper_trade_count={report['summary']['virtual_paper_trade_count']}",
                f"social_sentiment_status={report['summary']['social_sentiment_status']}",
                "network_used=false",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-id", default="v2_13_m_20260712_acceptance")
    parser.add_argument("--source-v2-13-l-report-json", type=Path, default=SOURCE_V2_13_L_REPORT_JSON)
    parser.add_argument("--source-v2-13-l-pass-marker", type=Path, default=SOURCE_V2_13_L_PASS_MARKER)
    ...
    report = run_acceptance(
        ...
        run_id=args.run_id,
        command=command,
        source_v2_13_l_report_json=args.source_v2_13_l_report_json,
        source_v2_13_l_pass_marker=args.source_v2_13_l_pass_marker,
    )
    print(
        "V2.13-M Finnhub Quote Virtual PaperTrade Creation From Validated Evidence",
