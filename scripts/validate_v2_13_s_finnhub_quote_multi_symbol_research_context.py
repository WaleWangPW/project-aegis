#!/usr/bin/env python3
"""Validate V2.13-S Finnhub quote multi-symbol research context bridge."""
...
from aegis.external_sources.finnhub_quote_multi_symbol_research_context import (  # noqa: E402
    ACCEPTANCE_TARGET,
...
OUTPUT_ROOT = ROOT / "data" / "processed" / "v2_13_s_acceptance"
SOURCE_V2_13_R_REPORT_JSON = REPORTS_DIR / "v2_13_r_finnhub_quote_multi_symbol_live_probe_latest.json"
SOURCE_V2_13_R_PASS_MARKER = REPORTS_DIR / "V2_13_R_FINNHUB_QUOTE_MULTI_SYMBOL_LIVE_PROBE_PASS.marker"
...
PASS_MARKER = "V2_13_S_FINNHUB_QUOTE_MULTI_SYMBOL_RESEARCH_CONTEXT_PASS.marker"
FAIL_MARKER = "V2_13_S_FINNHUB_QUOTE_MULTI_SYMBOL_RESEARCH_CONTEXT_FAIL.marker"
REPORT_JSON = "v2_13_s_finnhub_quote_multi_symbol_research_context_latest.json"
REPORT_MD = "v2_13_s_finnhub_quote_multi_symbol_research_context_latest.md"
...
def run_acceptance(
    *,
    ...
    run_id: str = "v2_13_s_20260712_acceptance",
    command: str | None = None,
    source_v2_13_r_report_json: Path = SOURCE_V2_13_R_REPORT_JSON,
    source_v2_13_r_pass_marker: Path = SOURCE_V2_13_R_PASS_MARKER,
    ...
    source_report = _load_json(source_v2_13_r_report_json)
    ...
    context_json = run_dir / "finnhub_quote_multi_symbol_research_context.json"
    context_md = run_dir / "finnhub_quote_multi_symbol_research_context.md"
    _write_json(context_json, report)
    context_md.write_text(render_finnhub_quote_multi_symbol_research_context_markdown(report), encoding="utf-8")
    ...
    checks = {
        **report["checks"],
        ...
        "source_v2_13_r_marker_exists": source_v2_13_r_pass_marker.exists(),
    ...
    report["source_v2_13_r_report_json"] = str(source_v2_13_r_report_json)
    report["source_v2_13_r_pass_marker"] = str(source_v2_13_r_pass_marker)
    report["production_record_files_before"] = before
    report["production_record_files_after"] = after
    report["hashes"] = {
        "source_v2_13_r_report_json": _sha256(source_v2_13_r_report_json),
        "source_v2_13_r_pass_marker": _sha256(source_v2_13_r_pass_marker),
    ...
    report_md.write_text(render_finnhub_quote_multi_symbol_research_context_markdown(report), encoding="utf-8")
    ...
    (reports_dir / marker_name).write_text(
        "\n".join(
            [
                ...
                f"source_v2_13_r_report_json={source_v2_13_r_report_json}",
                f"source_v2_13_r_report_json_sha256={_sha256(source_v2_13_r_report_json)}",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-id", default="v2_13_s_20260712_acceptance")
    parser.add_argument("--source-v2-13-r-report-json", type=Path, default=SOURCE_V2_13_R_REPORT_JSON)
    parser.add_argument("--source-v2-13-r-pass-marker", type=Path, default=SOURCE_V2_13_R_PASS_MARKER)
    ...
    report = run_acceptance(
        ...
        run_id=args.run_id,
        command=command,
        source_v2_13_r_report_json=args.source_v2_13_r_report_json,
        source_v2_13_r_pass_marker=args.source_v2_13_r_pass_marker,
    )
    print(
        ACCEPTANCE_TARGET,
