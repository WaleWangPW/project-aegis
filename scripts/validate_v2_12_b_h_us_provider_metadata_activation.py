#!/usr/bin/env python3
"""Validate V2.12-B H/US provider metadata activation proposal."""
...
from aegis.external_sources.h_us_provider_metadata_activation import (  # noqa: E402
    build_h_us_provider_metadata_activation,
    render_h_us_provider_metadata_activation_markdown,
)

REPORTS_DIR = ROOT / "data" / "reports"
OUTPUT_ROOT = ROOT / "data" / "processed" / "v2_12_b_acceptance"
SOURCE_PROBE_REPORT_JSON = ROOT / "data" / "reports" / "v2_12_a_eodhd_twelve_h_us_provider_probe_latest.json"

PASS_MARKER = "V2_12_B_H_US_PROVIDER_METADATA_ACTIVATION_PASS.marker"
FAIL_MARKER = "V2_12_B_H_US_PROVIDER_METADATA_ACTIVATION_FAIL.marker"
REPORT_JSON = "v2_12_b_h_us_provider_metadata_activation_latest.json"
REPORT_MD = "v2_12_b_h_us_provider_metadata_activation_latest.md"
...
def run_acceptance(
    *,
    ...
    run_id: str = "v2_12_b_20260712_acceptance",
    ...
    packet_json = run_dir / "h_us_provider_metadata_activation.json"
    packet_md = run_dir / "h_us_provider_metadata_activation.md"
    _write_json(packet_json, packet)
    packet_md.write_text(render_h_us_provider_metadata_activation_markdown(packet), encoding="utf-8")

    checks = {
        **packet["checks"],
        "acceptance_target_correct": packet["acceptance_target"] == "V2.12-B H-US Provider Metadata Activation",
    ...
    report_md.write_text(render_h_us_provider_metadata_activation_markdown(packet), encoding="utf-8")
    ...
    (reports_dir / marker_name).write_text(
        "\n".join(
            [
                ...
                "target=V2.12-B H-US Provider Metadata Activation",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-id", default="v2_12_b_20260712_acceptance")
    ...
    print(
        ...
        f"h_route={report['summary']['h_route']}",
        f"us_route={report['summary']['us_route']}",
        f"twelve_data_h_status={report['summary']['twelve_data_h_status']}",
