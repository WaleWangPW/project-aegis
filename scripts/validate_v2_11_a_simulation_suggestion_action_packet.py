#!/usr/bin/env python3
"""Validate Project Aegis V2.11-A simulation suggestion action packet."""
...
from aegis.paper.simulation_action_packet import (  # noqa: E402
...
OUTPUT_ROOT = ROOT / "data" / "processed" / "v2_11_a_acceptance"
CURRENT_BRIEF_JSON = ROOT / "data" / "reports" / "v2_9_h_current_usable_simulation_brief_latest.json"
API_BACKED_BRIEF_JSON = ROOT / "data" / "reports" / "v2_10_d_api_backed_candidate_usable_brief_latest.json"
RECORD_PATHS = {
...
PASS_MARKER = "V2_11_A_SIMULATION_SUGGESTION_ACTION_PACKET_PASS.marker"
FAIL_MARKER = "V2_11_A_SIMULATION_SUGGESTION_ACTION_PACKET_FAIL.marker"
REPORT_JSON = "v2_11_a_simulation_suggestion_action_packet_latest.json"
REPORT_MD = "v2_11_a_simulation_suggestion_action_packet_latest.md"
...
def run_acceptance(
    *,
    ...
    run_id: str = "v2_11_a_20260711_acceptance",
    ...
    packet_json = run_dir / "simulation_suggestion_action_packet.json"
    packet_md = run_dir / "simulation_suggestion_action_packet.md"
    _write_json(packet_json, packet)
    packet_md.write_text(render_simulation_action_packet_markdown(packet), encoding="utf-8")

    checks = {
        **packet["checks"],
        "acceptance_target_correct": packet["acceptance_target"] == "V2.11-A Simulation Suggestion Action Packet",
    ...
    report_md.write_text(render_simulation_action_packet_markdown(packet), encoding="utf-8")
    ...
    (reports_dir / marker_name).write_text(
        "\n".join(
            [
                ...
                "api_backed_candidates_not_claimed=true",
                "",
            ]
        ),
        encoding="utf-8",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-id", default="v2_11_a_20260711_acceptance")
